 ...
 * `IconSortUp`
 * -----------
 * Triángulo pequeño apuntando hacia arriba, usado como indicador
 * de orden ascendente en los headers de tablas de ecommerce
 * (`TransactionList`, `ProductListTable`).
 *
...
export class IconSortUpComponent {
  readonly size = input<number | string>(8);
