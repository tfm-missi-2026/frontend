 ...
 * `IconInfoCircle`
 * ----------------
 * Círculo con una "i". Usado como icono por defecto del `UiAlert`
 * cuando `variant="info"`.
 *
 * Variante de 24×24 de `IconInfo` (que es 16×16) — ambos existen
 * porque el alert los necesita más grandes para acompañar al texto.
 *
