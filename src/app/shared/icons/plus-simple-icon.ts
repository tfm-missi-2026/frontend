 ...
 * `IconPlusSimple`
 * ---------------
 * Signo "+" simple, stroke-based, usado en el botón "Add New Card" de
 * `PaymentMethod` y en el botón "Add Product" de `ProductListTable`.
 *
 * Variante de 20×20 / 21×20 de `IconPlus` (que es 12×12 fill-based).
 *
...
export class IconPlusSimpleComponent {
