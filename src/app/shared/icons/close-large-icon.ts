 ...
 * `IconCloseLarge`
 * ----------------
 * Cruz grande (24×24) usada como acción de cierre en la cabecera del
 * dropdown de notificaciones (`NotificationDropdown`).
 *
 * A diferencia de `IconX` (10×10, stroke-based), esta versión es
 * fill-based y más grande, pensada para botones de cierre tipo
 * "modal/drawer".
 *
...
export class IconCloseLargeComponent {
