 ...
 * `IconGoogle`
 * -----------
 * Logo de Google usado en los botones de OAuth de los formularios
 * de auth (`Sign in with Google`, `Sign up with Google`).
 *
 * Cada path utiliza el color de marca correspondiente (#4285F4,
 * #34A853, #FBBC05, #EB4335), por lo que no se ve afectado por la
 * propiedad `color` (siempre renderiza con los colores oficiales).
 */
@Component({
  selector: 'IconGoogle',
  standalone: true,
