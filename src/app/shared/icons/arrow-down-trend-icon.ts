 ...
 * `IconArrowDownTrend`
 * -------------------
 * Flecha hacia abajo usada como indicador de tendencia negativa en
 * el KPI "Target" de `MonthlyTarget`.
 *
 * Color hardcoded a rojo (#D92D20) para que mantenga el significado
 * semántico de "baja", no se ve afectado por la propiedad `color`.
 */
@Component({
...
export class IconArrowDownTrendComponent {
