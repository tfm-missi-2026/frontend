 ...
 * `IconUploadLarge`
 * -----------------
 * Variante de 29×28 del icono "subir" (flecha hacia arriba + bandeja
 * inferior) usada en el centro del `Dropzone` como pista visual para
 * arrastrar y soltar archivos.
 *
 * A diferencia de `IconUpload` (24×24, stroke-based), esta versión usa
 * `fill="currentColor"`, por lo que se controla con la propiedad
...
export class IconUploadLargeComponent {
