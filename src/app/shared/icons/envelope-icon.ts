 ...
 * `IconEnvelope`
 * -------------
 * Icono "sobre" usado como prefijo en los campos de email del
 * `InputGroup` de los formularios de autenticación.
 *
 * Usa `fill` con un color fijo (#667085) heredado del diseño original
 * para mantener el contraste con el fondo del input.
 */
@Component({
