 ...
 * `IconTrash`
 * ----------
 * Icono "papelera" usado como acción de borrado en la tabla de
 * productos del invoice (`CreateInvoiceTable`).
 *
 * Variante de 20×20 fill-based de `IconTrashLight` (que es 16×16).
 *
