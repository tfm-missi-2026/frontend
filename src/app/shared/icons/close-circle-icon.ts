 ...
 * `IconCloseCircle`
 * -----------------
 * Cruz pequeña (14×14) usada como acción de "quitar opción" en el
 * `MultiSelectComponent` cuando se elimina un chip seleccionado.
 *
...
export class IconCloseCircleComponent {
