 ...
 * `IconCheckCheckbox`
 * -------------------
 * Checkmark blanco de 14×14 usado como indicador visual de "checked"
 * dentro del componente `CheckboxComponent` cuando está seleccionado.
 *
...
export class IconCheckCheckboxComponent {
