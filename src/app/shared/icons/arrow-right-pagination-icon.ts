 ...
 * -------------------------
 * Flecha apuntando a la derecha, usada en los botones "Next" de la
 * paginación de las tablas de ecommerce (`TransactionList`,
...
export class IconArrowRightPaginationComponent {
