...
import type { LineStrokeCurve } from "./types";

/**
 * `ChartLine`
 * -----------
 * Line chart multi-serie sin relleno, construido sobre `apexcharts`.
 *
 * Capacidades:
 *  - Multi-serie con paleta de marca.
 *  - Curva `straight`, `smooth` o `stepline`.
 *  - Marcadores configurables en tamaño.
...
export class ChartLineComponent {
  ...
  readonly strokeCurve = input<LineStrokeCurve>("straight");
