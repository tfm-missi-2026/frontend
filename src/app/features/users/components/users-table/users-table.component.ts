    ...
    >
      @if (users().length === 0) {
        ...
        >
          ...
          <UiLabel type="bodyS" color="textWeak" className="mt-2">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
              @for (u of pagedUsers(); track u.id) {
                <tr class="hover:bg-gray-50 dark:hover:bg-white/3">
                  ...
                  <td
                    class="px-4 py-3.5 font-mono text-xs text-gray-600 dark:text-gray-400"
                  >
                    {{ u.email }}
                  </td>
                  <td class="px-4 py-3.5">
        ...
        >
          ...
          <UiFlex direction="row" alignItems="center" [gap]="8">
            <button
              type="button"
